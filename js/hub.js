...
window.HUB_ONEDRIVE_BUILD = "2026-09-21-worker-flow-v5";
...
async function openOneDriveDocument(d){
 if(d?.webUrl){window.open(d.webUrl,"_blank","noopener");return;}
 alert("El documento no tiene un enlace de apertura disponible.");
}

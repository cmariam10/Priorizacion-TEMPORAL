...
(function injectProjectListStyles(){
  ...
  s.textContent=`
    ...
    @media(max-width:900px){
      .ficha-summary-grid,.ficha-all-data,.ficha-map-layout{grid-template-columns:1fr}
...
function renderFicha(id){
 ...
 const geo=inferGeo(p), step=steps.find(s=>s.n==p.step)||steps[0], advance=Math.round((p.step/17)*100);
 ...
 fichaBox.innerHTML=`<article class="ficha-card ficha-completa">
  ...
  <div class="ficha-section">
    <div class="ficha-section-head"><div><h4>Resumen del proyecto</h4><p class="muted">Estado actual y ubicación dentro del flujo HUB.</p></div><div class="ficha-updated"><small>Última actualización en base maestra</small><b>${fichaEscape(fichaDate(updated))}</b></div></div>

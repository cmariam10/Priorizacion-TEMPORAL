...
window.HUB_ONEDRIVE_BUILD = "2026-09-21-worker-flow-v4";
...
(function injectHubModalLayerFix(){
 ...
 st.textContent=`
 body > .modal.open, body > [class*="modal"].open { z-index:2147483640 !important; }
 body > .modal.open > *, body > [class*="modal"].open > * { position:relative; z-index:2147483641 !important; }
 .leaflet-container,.leaflet-pane,.leaflet-top,.leaflet-bottom { max-z-index:1; }
 `;

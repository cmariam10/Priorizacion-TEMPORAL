...
const ROLE_DISPLAY_STEPS={tecnico:"1",jefatura:"2",planeamiento:"3",direccion:"4",coordinador:"5",secretaria:"6 y 8",areas:"7",sistema:"8",comite:"9",ejecutor:"10–17",administrador:"1–17"};
...
async function refreshBadgesAfterSharedSync(){
 ...
 try{
  ...
  renderFlow();renderKpis();renderMatrix();renderDetail();renderList();renderInbox();

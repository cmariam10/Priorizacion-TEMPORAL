...
function renderRegistrationForm(data={},existingGeometry=undefined){
 ...
 // Puede renderizarse mientras la vista Registrar aún está oculta.
 const geometryForThisRender = existingGeometry !== undefined ? existingGeometry : (window.__editingGeometry||null);
 setTimeout(()=>initRegistrationLocation(geometryForThisRender),120);
}
